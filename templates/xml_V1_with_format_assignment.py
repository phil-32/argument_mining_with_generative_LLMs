...
```"""
prompt_dict["pre_demo"] = "Assignment of the example output:\n\"\"\"{assignment}\"\"\"\nExample essay output written in resonse to the assignment with discourse unit annotations:"

prompt_dict["pre_essay"] = "The assignment of the essay was:\n\"\"\"{assignment}\"\"\"\nOutput all discourse units of the following essay which was written in response to the assignment. Use the XML-like syntax:"
